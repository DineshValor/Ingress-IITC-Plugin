...
// @version        1.0.1
// @downloadURL    https://iitc.willbe.blue/download/7785/gSt3UNjdGXZJe8dltOewfGEyMmM1NmVjN2FmODA2ZDYxYTBmODMxNWRhNmYzMDczMTMwNGNhZjA5OGExNmU3YTM3NTdlMmM3MTAwOGFjNGGj-RVNrqlnVC98P2StO8_dkCZHtnNxWpU8luhM8-andUAn1iuvQM8G0GtE9kX8gvlMV5yswnUyQa_TiSF10fuhOC6bUDQQWk8VYyALGIRxMQ==/            iitc-plugin-link-show-age.user.js
// @updateURL      https://iitc.willbe.blue/update-header/7785/BFSBfv4K5bHdVHfZX0058TU3YTIzYzhmODkzZjBhMmM3ZDcyZTUxNTc2NjhiZWY1NzliMzJhMGI3MmVmOWUwNzZkMjcyZjMxZDJmOThlNTZ8hag9na-81PZiDuOqUS9OdFEIzFJUeKCD2Uit9BA8MvZTxHUCQM5EU0GWiGmRzZ8TJT2QVoX9PACtJW6kTmsqqMtO-E1KuNc3o6LM3uDy3w==/            iitc-plugin-link-show-age.user.js
// @description    Shows recent links and shows when a link was thrown, also origin and destination portal
...
// ==/UserScript==
 ...
             linkData.setStyle({opacity: opacity, weight: width, clickable: true, interactive: true});
         }
     };
 
     self.removeLinkAge = function() {
         for(var link in window.links) {
             window.links[link].setStyle({opacity: 1, weight: 2, clickable: true, interactive: true});
         }
     };
 ...
         var R = 6367; // Radius of the earth in km
 ...
             link.setStyle({clickable: true, interactive: true});
